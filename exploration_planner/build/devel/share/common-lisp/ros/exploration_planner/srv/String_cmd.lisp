...
(cl:defmethod cl:initialize-instance :after ((m <String_cmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String_cmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exploration_planner-srv:<String_cmd-request> is deprecated: use exploration_planner-srv:String_cmd-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <String_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exploration_planner-srv:cmd-val is deprecated.  Use exploration_planner-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<String_cmd-request>)))
  ...
  "exploration_planner/String_cmdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'String_cmd-request)))
  "Returns string type for a service object of type 'String_cmd-request"
  "exploration_planner/String_cmdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <String_cmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String_cmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exploration_planner-srv:<String_cmd-response> is deprecated: use exploration_planner-srv:String_cmd-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <String_cmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exploration_planner-srv:res-val is deprecated.  Use exploration_planner-srv:res instead.")
  (res m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<String_cmd-response>)))
  ...
  "exploration_planner/String_cmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'String_cmd-response)))
  "Returns string type for a service object of type 'String_cmd-response"
  "exploration_planner/String_cmdResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'String_cmd)))
  ...
  "exploration_planner/String_cmd")